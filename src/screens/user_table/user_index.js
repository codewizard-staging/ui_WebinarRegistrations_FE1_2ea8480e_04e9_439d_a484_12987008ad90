...
const columns = [
    ...
    { headerName: "PhoneNumber", field: "PhoneNumber", flex: 1 },
    { headerName: "Company", field: "Company", flex: 1 },
    { headerName: "JobTitle", field: "JobTitle", flex: 1 },
    ...
    return (
        ...
        <>
            <Container {...props}>
                ...
                <Box style={{ width: '100%' }}>
                    <DataTable keyId={'UserId'} columns={columns} rowsCount={rowsCount} rows={rows} sortBy={sortBy} pageInfo={pageInfo} onActionClicked={OnActionClicked}
